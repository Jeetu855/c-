...
int main(){
    ...
    cin>>operation;
    switch(operation){ // in switch, the control expression must evaluate to an integer type
        case '+':cout<<"The sum is "<<num1+num2<<endl; //cannot use double quotes for case ''
        break;
        case '-':cout<<"The difference is "<<num1-num2<<endl; 
        break;
        case '/':cout<<"The division is "<<num1/num2<<endl; 
        break;
        case '*':cout<<"The product is "<<num1*num2<<endl; 
        break;
        default:cout<<"No operation specified"<<endl;
