...
int main(){
    // arguments r the values that can be passed inside a function: eg:getline(cin,name)
    
    // arguments r called parameters, they must match in number, order and type
    // int result{};
    // result=add(38,12);
    // cout<<result;
    ...
    // when we pass a value to func, a cpoy of that value is passed to func eg:
