...
int main(){
    ...
    // say_hello();// function being called has to be declared b4 from the place its being called
    // because it needs to check if func has a return val and if the paramters entered r ccorrect or not
