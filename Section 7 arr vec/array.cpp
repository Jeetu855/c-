...
int main()
{
    ...
    //* name of the array represents location of first element i.e element at [0],means the name of array is a pointer
    //* compiler uses sizeof() to go to the location of requested element
    // array values not constant so we can change
    test_scores[0] = 92; //* arrays are mutable
...
// *Fixed size, All elements same type, stored contiguously in memory, no bounds check,mutable
