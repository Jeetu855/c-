...
int main()
{
    ...
    // cout<<static_cast<double>(total)/number<<endl; //convert either one of them to a double
    ...
    //* short circuit evaluation eg1:exp1 && exp2 && exp3 if first condition is false, it wont bother checking 2nd and 3rd condition
    //* eg2:exp1 || exp2|| exp 3 ,if first condition true it wont check other conditions

    // compound operator:operators followed by = symbol:used to manipulate bits and are called bit wise operator
